    ...
    view!{cx,
        <div class="mx-auto grid max-w-2xl grid-cols-1 items-start justify-center gap-y-20 border-gray-200 px-4 pb-16 dark:border-gray-900 sm:px-8 md:grid-cols-2 md:gap-x-20">
            ...
            <section>
                ...
                />
                <address
                    class="my-4 w-full transform rounded-xl bg-gradient-to-r from-yellow-400 via-rose-400 to-cyan-500 p-1 transition-all hover:scale-[1.01]"
                >
                    <section class="flex flex-col rounded-lg bg-white p-4 dark:bg-gray-900">
                        ...
                        <a href="mailto:ben@benw.is" class="text-black dark:text-white">"Email"</a>
                        <a href="https://twitter.com/iambenwis" class="text-black dark:text-white">"Twitter"</a>
                    </section>
                </address>
            </section>
        </div>
