...
pub fn Nedry() -> impl IntoView {
    view! {
        ...
        <section class="pt-6">
            <img class="mx-auto" src="/img/Ahahah.webp" alt="Ah-Ah-Ah! You Didn't Say The Magic Word"/>
            <h1 class="text-3xl text-black dark:text-white">"Ah-Ah-Ah! You Didn't Say The Magic Word!"</h1>
        </section>
    }
}
