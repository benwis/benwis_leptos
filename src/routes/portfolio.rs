        ...
        <div class="mt-16 mb-32 w-full max-w-none dark:prose-invert">
            ...
            >
                <PortfolioCard
                    ...
                    description="Praxis Cycles is a bike parts supplier that does over a million dollars in annual sales. I redesigned the site to a media heavy layout, optimized image distribution, and massively decreased page load time".to_string()
                />
                <PortfolioCard
                    ...
                    description="Praxis' OEM site is a login only site that lists their hundreds of available parts for dealers to purchase. I built the frontend using Remix, React, and TailwindCSS. The backend is a custom rust GraphQL server linked to Airtable and Sanity for data entry.".to_string()
                />
            </main>
        </div>
    </article>
